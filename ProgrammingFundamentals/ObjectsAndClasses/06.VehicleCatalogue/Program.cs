...
namespace _06.VehicleCatalogue
{
    class VehiclesCatalogue
    {
        ...
        public VehiclesCatalogue(string typeOfVehicle, string modelOfVehicle, string colorOfVehicle,
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                VehiclesCatalogue vehiclesCatalogue =
                    new VehiclesCatalogue(typeOfVehicle, modelOfVehicle, colorOfVehicle, horsepowerOfVehicle);
